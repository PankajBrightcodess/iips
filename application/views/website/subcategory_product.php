      ...
      <div class="row">
        <div class="col-lg-3">
          <div class="FilterOptions">
            <div class="filterCategories">
              ...
              if(!empty($sidemenulist)){
                  foreach($sidemenulist as $s_menu){
                      if($s_menu['id'] == $subcategory['cat_id']){ ?>
              ...
              <?php       
                  ...
                  <li><a href="<?php echo base_url("subcat/$sub_menu[slug]"); ?>" <?php if($sub_menu['id'] == $subcategory['id']){ echo "class='ActiveList'";}?>><?php echo $sub_menu['name'];?></a></li>  
                  <?php if(!empty($sub_menu['lowcat'])){
                    $lowmenulist = $sub_menu['lowcat'];
                    echo '<ul class="last_category">';
                    foreach($lowmenulist as $l_list){ ?>
                  <li><a href="<?php echo base_url("lowcat/$l_list[slug]"); ?>" class='text-info'><?php echo $l_list['name'];?></a></li>  
                  <?php }
                    echo '</ul>';
                  }?>                      
              <?php   } 
            ...
            <div class="PriceRange">
              ...
              <input type='hidden' id='cat_id' value='<?php echo $subcategory['cat_id'];?>'/>
              <input type='hidden' id='subcat_id' value='<?php echo $subcategory['id'];?>'/>
        ...
        <div class="col-lg-9">
          <div class="FilterProducts">
            <div class="row">
              <div class="col-lg-9 pl-2 pr-2"><h2><?php echo strtoupper($subcategory['name']);?> <span id='counted_show'>( <?php echo count($productlist)?></span> <i>products</i>)</h2><hr></div>
    ...
    <script>
      function filter_func(){
        ...
        $.ajax({
            ...
            data:{catid:cat_id,subcatid:subcat_id,discount:discount,pricerange:pricerange,quantity:quantity,prod_order:prod_order},
