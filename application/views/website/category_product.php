      ...
      <div class="row">
        <div class="col-lg-3">
          <div class="FilterOptions">
            <div class="filterCategories">
              ...
              if(!empty($sidemenulist)){
                  foreach($sidemenulist as $s_menu){
                      if($s_menu['id'] == $category['id']){ ?>
                <p><a href="<?php echo base_url("cat/$s_menu[slug]");?>" class="ActiveList"><?php echo $s_menu['name'];?></a></p>    
              <?php       
                  if(!empty($s_menu['subcat'])){
                    $submenulist = $s_menu['subcat'];
                    echo '<ul class="full_space">';
                    foreach($submenulist as $sub_menu){ ?>
                  <li><a href="<?php echo base_url("subcat/$sub_menu[slug]"); ?>" class='text'><?php echo $sub_menu['name'];?></a></li>  
            ...
            <div class="PriceRange">
              ...
              <input type='hidden' id='cat_id' value='<?php echo $category['id'];?>'/>
        ...
        <div class="col-lg-9">
          <div class="FilterProducts">
            <div class="row">
              <div class="col-lg-9 pl-2 pr-2"><h2><?php echo strtoupper($category['name']);?> <span id='counted_show'>( <?php echo count($productlist)?></span> <i>products</i>)</h2><hr></div>
    ...
    <script>
      function filter_func(){
        ...
        $.ajax({
            ...
            data:{catid:cat_id,discount:discount,pricerange:pricerange,quantity:quantity,prod_order:prod_order},
