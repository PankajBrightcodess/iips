                  ...
                  <!---------------------------------- End of Response Msg --------------------------------------->
                    <div class="login-form">
                      ...
                      <form action="<?php echo base_url('website/saveregister');?>" method='POST'>
                        <input type="text" name="name" placeholder="Name:" class="form-control my-2 py-2" required="">
                        <input type="email" name="email" placeholder="Email:" class="form-control my-2 py-2" required="">
                        <input type="text" name="mobileno" placeholder="Mobile No:" class="form-control my-2 py-2" required>
                        <input type="password" name="password" placeholder="Password:" class="form-control my-2 py-2" required>
                        <input type="password" name="con_password" placeholder="Confirm Password:" class="form-control my-2 py-2" required>
                        <button type="submit" class="btn btn-success" name="login">Register</button>
                         <a href="<?php echo base_url('/login') ?>" class="btn btn-warning">Login</a>
                      </form>
