            ...
            <div class="row" style='background-color:#f9eeb8;'>
                ...
                <div class="col-md-10 p-3">              
                    ...
                    <div class="row mt-3 mb-5">                
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="row mt-1">
                                                    <div class="col-md-8">
                                                        ...
                                                        <div class="col-4" style='text-align:center;'> 
                                                            <img src='<?php echo file_url($addonmenu['path']);?>' alt="<?php echo $addonmenu['name'];?>" class='img-fluid' title="<?php echo $addonmenu['name'];?>" />
                                                ...
                                                <form action='<?php echo base_url('app/placeorder');?>' method="POST">
                                                <div class="row mt-3">
                        ...
                        <div class='col-md-2 card p-3 sticky' style="max-height: 200px;">
