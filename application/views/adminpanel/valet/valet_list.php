                            ...
                            <tr>
                                ...
                                <td><?php echo $list['aadhar']?></td>
                                  ...
                                  <td width='10%'><img src="<?php echo file_url($list['picture']);?>" width='100%' alt='staff_image'/></td>
          							s <td><?php echo $list['loc']?></td>
                                    <td><?php echo $list['pincode']?></td>
                                    
                               
                               <td align="center"><a href="<?php echo base_url('admin/valet/edit_valet/').$list['id'];?>"><span class="btn btn-sm btn-warning fa fa-info"></span></a> 
	...
	$(document).ready(function(e) {
      ...
      $('body').on('click','.del',function(){
		var del=$(this).val();
		  ...
		  $.ajax({
			  method:'POST',
			  url:"<?php echo base_url('admin/valet/delete_rec')?>",
			  data:{id:del},
