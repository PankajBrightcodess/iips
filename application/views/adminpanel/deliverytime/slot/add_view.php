    	...
    	<div class="row">
        	<div class="col-md-12">
                <div class="card">
                    ...
                    <div class="row">
                        	<div class="col-md-6">
                                <?php echo form_open_multipart('admin/deliverytime/saveslot');?>
                                <div class="form-group row">
                                    <label class="col-sm-12 col-md-4 col-form-label">Select Location<span class='text-danger'>*</span></label>
                                    <div class="col-sm-12 col-md-6">
                                        <?php echo form_dropdown(array('name'=>'location_id','class'=>'form-control','required'=>'true'),$maincatoption); ?>
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-12 col-md-6">
                                        <?php echo form_input(array('type'=>'text','name'=>'name','id'=>'cat_name','class'=>'form-control','placeholder'=>'Enter Slot Name','required'=>'true'));?>
                                    </div>
                                    <div class="col-md-2"></div>
                                </div> 
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-12 col-md-6">
                                        ...
                                        <?php echo form_dropdown(array('name'=>'slot_type','class'=>'form-control','required'=>'true'),$typearray);?>
                                    </div>
                                    <div class="col-md-2"></div>
                                </div>  
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-12 col-md-6">                                        
                                        <?php echo form_input(array('type'=>'number','name'=>'slot_price','class'=>'form-control','placeholder'=>'Enter Slot Price','required'=>'true'));?>
                                    </div>
                                    <div class="col-md-2"></div>
                                </div>                              
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-4">                                        
                                        <?php echo form_submit(array('name'=>'save_slot','id'=>'save_slot','value'=>'Save Slot','class'=>'form-control btn btn-success'));?>
                                    </div>
                                    <div class="col-md-4"></div>                                    
                                </div>
                                <?php echo form_close();?>
