    	...
    	<div class="row">
        	<div class="col-md-12">
                <div class="card">
                    ...
                    <div class="row">
                        	<div class="col-md-6">
                                <?php echo form_open_multipart('admin/deliverytime/updatezone');?>                                
                                <div class="form-group row">
                                    <label class="col-sm-12 col-md-4 col-form-label">Zone Name <span class='text-danger'>*</span></label>
                                    <div class="col-sm-12 col-md-6">
                                        <?php echo form_input(array('type'=>'text','name'=>'name','id'=>'zone_name','class'=>'form-control','value'=>$onezone['name'],'placeholder'=>'Enter Zone Name','required'=>'true'));?>
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-12 col-md-6">                                        
                                        <?php echo form_input(array('type'=>'number','name'=>'pincode','maxlength'=>'6','class'=>'form-control','value'=>$onezone['pincode'],'placeholder'=>'Enter Zone Pincode','required'=>'true'));?>
                                    </div>
                                    <div class="col-md-2"></div>
                                </div>                              
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-4">  
                                        ...
                                        <?php echo form_submit(array('name'=>'save_zone','id'=>'save_zone','value'=>'Update Zone','class'=>'form-control btn btn-success'));?>
                                    </div>
                                    <div class="col-md-4"></div>                                    
                                </div>
                                <?php echo form_close();?>
