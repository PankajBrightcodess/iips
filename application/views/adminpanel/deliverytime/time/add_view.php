    	...
    	<div class="row">
        	<div class="col-md-12">
                <div class="card">
                    ...
                    <div class="row">
                        	<div class="col-md-6">
                                <?php echo form_open_multipart('admin/deliverytime/savetime');?>
                                <div class="form-group row">
                                    <label class="col-sm-12 col-md-4 col-form-label">Select Location<span class='text-danger'>*</span></label>
                                    <div class="col-sm-12 col-md-6">
                                        <?php echo form_dropdown(array('name'=>'location_id','id'=>'location_id','class'=>'form-control','required'=>'true'),$maincatoption); ?>
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-12 col-md-6">                                        
                                        <input type="number" min="0" max="23" name='time_from[]' value='00' placeholder="23">:
                                        <input type="number" min="0" max="59" name='time_from[]' value='00' placeholder="00"> Hours(24 hours)
                                    </div>
                                    <div class="col-md-2"></div>
                                </div>  
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-12 col-md-6">                                        
                                        <input type="number" min="0" max="23" name='time_to[]' value='23' placeholder="23">:
                                        <input type="number" min="0" max="59" name='time_to[]' value='00' placeholder="00"> Hours(24 hours)
                                    </div>
                                    <div class="col-md-2"></div>
                                </div>                              
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-4">                                        
                                        <?php echo form_submit(array('name'=>'save_time','id'=>'save_time','value'=>'Save Delivery Time','class'=>'form-control btn btn-success'));?>
                                    </div>
                                    <div class="col-md-4"></div>                                    
                                </div>
                                <?php echo form_close();?>
