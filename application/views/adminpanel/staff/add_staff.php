        ...
        <div class="row">
        	<div class="col-md-12">
            	<div class="card">
                    ...
                    <div class="card-body">
						<form action="<?php echo base_url('admin/staff/add_staff_op');?>" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                                ...
                                <div class="col-sm-12 col-md-6">
                                	<div class="row form-group">
                                        ...
                                        <div class="col-sm-12 col-md-8">
                                            <input type="text" name="name" value="" id="name" placeholder="Name" class="form-control" required="true">
                                        </div>
                                    </div>
                                    <div class="row form-group">
                                        <label class="col-sm-12 col-md-2 col-form-label">Father's Name <span class="text-danger">*</span></label>
                                        <div class="col-sm-12 col-md-8">
                                            <input type="text" name="father" value="" id="father" placeholder="Father's Name" class="form-control" required="true">
                                        </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12 col-md-4">
                                    <input type="number" name="mobile"  maxlength="10" id="mobile" placeholder="Mobile" class="form-control" maxlength="10">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12 col-md-4">
                                    <input type="text" name="town" value="" id="town" placeholder="Town" class="form-control">
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-12 col-md-4">
                                    <input type="text" name="district" value="" id="district" placeholder="District" class="form-control">
                                </div>
                                <label class="col-sm-12 col-md-1 col-form-label">State</label>
                                <div class="col-sm-12 col-md-4">
                                    <input type="text" name="state" value="" id="state" placeholder="State" class="form-control">
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-md-1"></div>
                                ...
                                <div class="col-sm-12 col-md-4">
                                    <input type="number" name="aadhar"  maxlength="14" id="aadhar" placeholder="Aadhar/UID" class="form-control">
                                      <span id="aadhar_result"></span>
                                </div>
                                <label class="col-sm-12 col-md-1 col-form-label">Bank A/c No.</label>
                                <div class="col-sm-12 col-md-4">
                                    <input type="text" maxlength="20" name="bank_ac" value="" id="bank_ac" placeholder="Bank a/c No." class="form-control">
                            ...
                            <div class="jumbotron" style="background-color:#ffffff;padding:0px 0px;">
                               ...
                               <label class="col-sm-12 col-md-2 col-form-label">Date of Joining <span class="text-danger">*</span></label>
                                        <div class="col-sm-12 col-md-4 mb-10">
                                            <input type="date" name="doj" value="" id="doj" class="form-control" required="true">
                                        </div>
            			 ...
            			 echo "<option value='".$list['id']."'>".$list['name']."</option>";
                            ...
                            <div class="form-group row">
                                ...
                                <label class="col-sm-12 col-md-2 col-form-label">Salary <span class="text-danger">*</span></label>
                                        ...
                                        <div class="col-sm-12 col-md-4 mb-10">
                                            <input type="text" name="salary" id="basic_salary" placeholder="Salary" class="form-control" required="true">
                                        </div>
