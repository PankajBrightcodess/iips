    	...
    	<div class="row">
        	<div class="col-md-12">
                <div class="card">
                    ...
                    <div class="row">
                    <div class="col-md-12">
                            <?php echo form_open_multipart('admin/addons/update_addons','id="myform"'); ?>
                                <div class="form-group row">
                                    <label class="col-sm-12 col-md-2 col-form-label">Product Name<span class="text-danger">*</span> </label>
                                    <div class="col-sm-12 col-md-4">
                                        <?php echo form_input(array('name'=>'product_name','class'=>'form-control','id'=>'product_name','value'=>$oneproduct['product_name'],'placeholder'=>'Enter Product Name'));?>
                                    </div>                                    
								 </div>
                                 <div class="form-group row">                                   
                                    <label class="col-sm-12 col-md-2 col-form-label">Main Category<span class="text-danger">*</span></label>
                                    <div class="col-sm-12 col-md-4">
                                        <?php echo form_dropdown(array('name'=>'cat_id','id'=>'maincat_id','class'=>'form-control'),$maincatoption,$oneproduct['cat_id']);?>
                                    </div>
                                    <label class="col-sm-12 col-md-2 col-form-label">Gst Rate <span class="text-danger">*</span> </label>
                                    <div class="col-sm-12 col-md-4">
                                        <?php echo form_dropdown(array('name'=>'gst_rate','id'=>'gst_rate','class'=>'form-control'),$gstrateoption,$oneproduct['gst_rate']);?>
                                    </div>
                                 </div>                                                 
                                 <div class="form-group row">                                   
                                    <label class="col-sm-12 col-md-2 col-form-label">Product Price<span class="text-danger">*</span></label>
                                    <div class="col-sm-12 col-md-4">
                                        <?php echo form_input(array('name'=>'price','min'=>'1','step'=>'0.01','type'=>'number','class'=>'form-control','value'=>$oneproduct['price'],'placeholder'=>'Enter Product Price'));?>
                                    </div>
                                    <label class="col-sm-12 col-md-2 col-form-label">Product min hold<span class="text-danger">*</span> </label>
                                    <div class="col-sm-12 col-md-4">
                                        <?php echo form_input(array('name'=>'stock_hold','min'=>'1','step'=>'1','type'=>'number','class'=>'form-control','value'=>$oneproduct['stock_hold'],'placeholder'=>'Enter Product Stock To Hold'));?>
                                    </div>
                                 </div>
                                 <div class="form-group row">                                   
                                    <label class="col-sm-12 col-md-2 col-form-label">Product Present Stock<span class="text-danger">*</span></label>
                                    <div class="col-sm-12 col-md-4">
                                        <?php echo form_input(array('name'=>'stock_qty','min'=>'1','step'=>'1','type'=>'number','class'=>'form-control','value'=>$oneproduct['stock_qty'],'placeholder'=>'Enter Product Qty Present In Stock'));?>
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-2 col-md-6">
                                        <?php   
                                            ...
                                            echo form_submit('addproducts', 'Update Product Addons', array('class'=>'btn btn-success btn-sm form-control','id'=>'submit-btn')); 
                                        ?>
