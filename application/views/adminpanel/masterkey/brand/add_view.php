    	...
    	<div class="row">
        	<div class="col-md-12">
                <div class="card">
                    ...
                    <div class="row">
                        	<div class="col-md-6">
                                <?php echo form_open_multipart('admin/masterkey/savebrand');?>
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-12 col-md-4 col-form-label">Brand Name <span class='text-danger'>*</span></label>
                                    <div class="col-sm-12 col-md-6">
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-12 col-md-4 col-form-label"> Brand Logo Image</label>
                                    <div class="col-sm-12 col-md-6">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-4">
                                        <?php echo form_hidden('type','brand');?>
                                        <?php echo form_submit(array('name'=>'save_flavor','id'=>'save_flavor','value'=>'Save Brand','class'=>'form-control btn btn-success'));?>
                                    </div>
                                    <div class="col-md-4"></div>                                    
                                </div>
                                <?php echo form_close();?>
                            	 ...
                            	 <table class="table data-table stripe hover nowrap table-bordered"> 
                                     <thead>
                                         <tr>
                                             ...
                                             <th class="no-sort">Brand Name</th>
                                     ...
                                     <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                            <a href='<?php echo base_url("admin/masterkey/editbrand/$list[id]");?>' class='btn btn-info btn-sm hoverable' data-container="body" data-toggle="popover" data-placement="top" data-content="Edit">
