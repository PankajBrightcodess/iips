    	...
    	<div class="row">
        	<div class="col-md-12">
                <div class="card">
                    ...
                    <div class="row">
                        	<div class="col-md-6">
                                <?php echo form_open_multipart('admin/masterkey/updatebrand');?>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <?php echo form_submit(array('name'=>'save_flavor','id'=>'save_flavor','value'=>'Update Brand','class'=>'form-control btn btn-success'));?>
                                    </div>
                                    <div class="col-md-4"></div>                                    
                                </div>
                                <?php echo form_close();?>
