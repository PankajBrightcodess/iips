    	...
    	<div class="row">
        	<div class="col-md-12">
                <div class="card">
                    ...
                    <div class="row">
                        	<div class="col-md-6">
                                <?php echo form_open_multipart('admin/masterkey/savecream');?>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-12 col-md-6">
                                        <?php echo form_input(array('type'=>'text','name'=>'name','id'=>'cat_name','class'=>'form-control','placeholder'=>'Cream Name','required'=>'true'));?>
                                    </div>
                                    <div class="col-md-2"></div>
                                </div>
                                <div class="form-group row">
                                ...
                                <table class='table table-bordered' id='adds'>
                                    <tr>
                                        ...
                                        <td>
                                        <?php echo form_dropdown(array('name'=>'size[]','class'=>'form-control','required'=>'true'),$sizeoption);?>
                                        </td>
                                        <th width='10%'>Price <span class='text-danger'>*</span></th>
                                        <td>
                                        <?php echo form_input(array('type'=>'number','step'=>'0.01','name'=>'price[]','class'=>'form-control','required'=>'true','placeholder'=>'Price'));?>
                                        </td>
                                        <td>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-4">                                        
                                        <?php echo form_submit(array('name'=>'save_shape','id'=>'save_shape','value'=>'Save Cream','class'=>'form-control btn btn-success'));?>
                                    </div>
                                    <div class="col-md-4"></div>                                    
                                </div>
                                <?php echo form_close();?>
                            	 ...
                            	 <table class="table data-table stripe hover nowrap table-bordered"> 
                                     ...
                                     <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <a href='#' data-table='cream' data-deleteid='<?php echo $list['id']; ?>' class='btn btn-danger btn-sm hoverable my_delete' data-container="body" data-toggle="popover" data-placement="top" data-content="Delete">
