    	...
    	<div class="row">
        	<div class="col-md-12">
                <div class="card">
                    ...
                    <div class="row">
                        	<div class="col-md-6">
                                <?php echo form_open_multipart('admin/masterkey/savecategory');?>
                                <div class="form-group row">
                                    <label class="col-sm-12 col-md-4 col-form-label">Category Name <span class='text-danger'>*</span></label>
                                    <div class="col-sm-12 col-md-6">
                                        <?php echo form_input(array('type'=>'text','name'=>'name','id'=>'cat_name','class'=>'form-control','placeholder'=>'Enter Category Name','required'=>'true'));?>
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-4">
                                        <?php echo form_submit(array('name'=>'save_cat','id'=>'save_cat','value'=>'Save Category','class'=>'form-control btn btn-success'));?>
                                    </div>
                                    <div class="col-md-4"></div>                                    
                                </div>
                                <?php echo form_close();?>
                            	 ...
                            	 <table class="table data-table stripe hover nowrap table-bordered"> 
                                     ...
                                     <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <a href='#' data-table='category' data-deleteid='<?php echo $list['id']; ?>' class='btn btn-danger btn-sm hoverable my_delete' data-container="body" data-toggle="popover" data-placement="top" data-content="Delete">
