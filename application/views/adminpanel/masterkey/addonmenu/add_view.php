    	...
    	<div class="row">
        	<div class="col-md-12">
                <div class="card">
                    ...
                    <div class="row">
                        	<div class="col-md-6">
                                <?php echo form_open_multipart('admin/masterkey/save_addonmenu');?>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-12 col-md-6">
                                        <?php echo form_input(array('type'=>'text','name'=>'name','id'=>'cat_name','class'=>'form-control','placeholder'=>'Add Menu Name','required'=>'true'));?>
                                    </div>
                                    <div class="col-md-2"></div>
                                </div>
                                <div class="form-group row">
                                ...
                                <table class='table table-bordered' id='adds'>
                                    <tr>
                                        <th width='15%'>Variant Quantity<span class='text-danger'>*</span></th>
                                        <td>
                            	 ...
                            	 <table class="table data-table stripe hover nowrap table-bordered"> 
                                     ...
                                     <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <a href='#' data-table='addonmenu' data-deleteid='<?php echo $list['id']; ?>' class='btn btn-danger btn-sm hoverable my_delete' data-container="body" data-toggle="popover" data-placement="top" data-content="Delete">
